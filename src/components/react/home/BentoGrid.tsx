...
export const BentoGrid = () => {
  ...
  const cardClasses = "relative h-full w-full rounded-[2.5rem] bg-white/[0.03] border border-white/8 backdrop-blur-2xl overflow-hidden isolate transition-colors duration-500";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px] md:auto-rows-[380px]">
          ...
          <Reveal delay={100} className="md:col-span-2 h-full">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-3xl font-semibold mb-3 text-white">Rendimiento Extremo.</h3>
                  <p className="text-gray-400 text-lg max-w-md font-light">Optimizamos la carga al milisegundo. Construimos arquitecturas modernas que retienen usuarios y dominan el SEO.</p>
                </div>
              </div>
            </div>
          </Reveal>

          {/* Card Pequeña 1 (ESCALABILIDAD - Layout Original Restaurado) */}
          <Reveal delay={200} className="md:col-span-1 h-full">
            ...
            >
              ...
              />
              <Layers className="w-12 h-12 text-white relative z-10" strokeWidth={1.5} />
              <div className="relative z-10 mt-auto">
                <h3 className="text-2xl font-semibold mb-2 text-white">Escalabilidad</h3>
                <p className="text-gray-400 font-light">Sistemas que crecen orgánicamente.</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={300} className="md:col-span-1 h-full">
            ...
            >
              ...
              />
              <Fingerprint className="w-12 h-12 text-[#288B88] relative z-10" strokeWidth={1.5} />
              <div className="relative z-10">
                <h3 className="text-2xl font-semibold mb-2 text-white">Seguridad Nativa</h3>
                <p className="text-gray-400 font-light">Protección de datos desde la base estructural.</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={400} className="md:col-span-2 h-full">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-3xl font-semibold mb-3 text-white">Stack Tecnológico.</h3>
                  <p className="text-gray-400 text-lg max-w-md font-light">React, Astro, Node, Tailwind. Empleamos las herramientas que impulsan a las empresas tecnológicas líderes del mundo.</p>
                </div>
              </div>
            </div>
          </Reveal>
