      ...
      <Reveal>
        <section className="text-center pt-15 pb-24 relative overflow-hidden">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto font-light leading-relaxed mb-12">
            Accede a nuestra red exclusiva de ingenieros y especialistas que han
            sido formados y rigurosamente validados por Quark Techie.
          </p>
          <Button
            variant="primary"
            size="lg"
      ...
      <section className="py-24 border-t border-white/5 relative">
        <Reveal>
          <div className="text-center mb-20 relative z-10">
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tighter mb-6 uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px] md:auto-rows-[380px] relative z-10">
          <Reveal delay={100} className="md:col-span-2 h-full">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <BookOpen
                  className="w-12 h-12 text-[#63A3A4]"
                  strokeWidth={1.5}
                />
                <div>
                  <h3 className="text-3xl font-semibold mb-3 text-white uppercase tracking-wider">
          ...
          <Reveal delay={200} className="md:col-span-1 h-full">
            ...
            >
              ...
              <div className="relative z-10 mt-auto">
                <h3 className="text-2xl font-semibold mb-2 text-white uppercase">
          ...
          <Reveal delay={300} className="md:col-span-1 h-full">
            ...
            >
              ...
              />
              <CheckCircle
                className="w-12 h-12 text-[#D9C58F] relative z-10"
                strokeWidth={1.5}
              />
              <div className="relative z-10">
                ...
                <p className="text-gray-400 font-light text-sm">
                  Pruebas técnicas reales que aseguran la excelencia estructural
                  en cada línea.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-lg max-w-md font-light">
                    Profesionales con experiencia práctica para impactar desde
                    el primer día en entornos de alta exigencia.
                  </p>
                </div>
              </div>
            </div>
